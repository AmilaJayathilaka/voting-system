...
$sql = "UPDATE votes_province SET votes=votes+1 WHERE name='$selectedValue'";
$result1= mysqli_query($con,$sql);
$votersql="UPDATE voters SET province=1 WHERE NIC='$id'";
            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <!--  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu"> -->
                        <li><a href="../index_user.php">Logout</a></li>
                <!--     </ul>
                </li> -->
            </ul>
        </div><!-- /.navbar-collapse -->
                    ...
                    <p class="help-block"><b> </b></p>
                            ...
                            <div class="form-group">
                                <select name="nominee1" class="form-control">
                                    ...
                                    $result=mysqli_query($con,"SELECT name FROM candidates_province WHERE party = '$party'");
