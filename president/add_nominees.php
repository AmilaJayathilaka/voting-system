...
if($party!="" && $party!="" && $district!=""){
    ...
    if($dd==null){
        $query = "INSERT INTO candidates(name, party, district ) VALUES('$name','$party','$district')";
        $query1 = "INSERT INTO votes(name,party,votes) VALUES('$name','$party','0')";
...
<?php
        ...
        $query = "UPDATE candidates SET name='$name', party='$party', district='$district' WHERE id = '".$dd."'";
        $query1 = "UPDATE votes SET name='$name',party='$party' WHERE id = '".$dd."'";
        $sql_run = mysqli_query($con,$query);
        $sql_run = mysqli_query($con,$query1);
...
$sql1="DELETE FROM votes WHERE id='$id'";
