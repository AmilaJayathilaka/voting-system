...
$result=mysqli_query($con,"SELECT * FROM candidates_local");
...
if($party!="" && $party!="" && $district!=""){
    ...
    if($dd==null){
        $query = "INSERT INTO candidates_local(name, party, district ) VALUES('$name','$party','$district')";
        $query1 = "INSERT INTO votes_local(name,party,votes) VALUES('$name','$party','0')";
...
<?php
        ...
        $query = "UPDATE candidates_local SET name='$name', party='$party', district='$district' WHERE id = '".$dd."'";
        $query1 = "UPDATE votes_local SET name='$name',party='$party' WHERE id = '".$dd."'";
        $sql_run = mysqli_query($con,$query);
        $sql_run = mysqli_query($con,$query1);
...
$sql="DELETE FROM candidates_local WHERE id='$id'";
$sql1="DELETE FROM votes_local WHERE id='$id'";
                    ...
                    <label for="organization">Party</label>
                        ...
                        <select required name="party" class="form-control" id="org-list" >
                            <option>****** SELECT Party****</option>
                               <?php
                                    $result=mysqli_query($con,"SELECT * FROM parties_local");
                                    while ($row = mysqli_fetch_array($result)) {
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
                            $sql = "SELECT * FROM candidates_local";
